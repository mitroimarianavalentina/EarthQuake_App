...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            //loop through the features to find all the earthquakes magnitude, place and time
            for (int i = 0; i< features.length(); i++){

                //find the current quake, using the index i into  JSON Object
                JSONObject currentQuake = features.getJSONObject(i);

                //once we know the current position in the features array, we can get the JSON Object for the "proprieties"
                JSONObject properties = currentQuake.getJSONObject("properties");

                //access the values from the proprieties: mag, place, time
                ...
                //create a new Earthquake object using these 3 proprieties
                Earthquake earthquake = new Earthquake(mag, place,time, url);

                //add this earthquake object to the ArrayList - earthquakes
